...
PARAM <- list()
PARAM$experimento <- "FE6310_f02"

PARAM$exp_input <- "DR6210_f02"
...
PARAM$RandomForest$semilla <- 222247 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 222247
